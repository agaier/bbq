...
from bbq.logging.mc_logger  import MCLogger as Logger
from bbq.mc_map_elites import map_elites


from bbq.emitters.mc_gaussian_emittter import GaussianEmitter
...
if __name__ == '__main__':
    ...
    base_config = 'config/multi_rast.yaml'
