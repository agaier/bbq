...
""" Provides Ribs Archives that take objects rather than np.arrays of floats"""

class GridArchive_Obj(ArchiveBase_Obj):
    ...
    def get_index(self, behavior_values):
        ...
        """
        index = GridArchive_Obj._get_index_numba(behavior_values,
                                             self._upper_bounds,
                                             self._lower_bounds,
